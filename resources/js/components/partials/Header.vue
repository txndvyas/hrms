            ...
            <nav class="navbar navbar-expand">
                <div class="collapse navbar-collapse justify-content-between">
                    ...
                    <ul class="navbar-nav header-right">
                        <li class="nav-itmes align-items-center d-flex">
                            <div class="input-group">
                                <span class="timer-style">{{ formattedTime }}</span>
                            </div>
                        </li>
                        <li class="nav-item">
                            <div class="form-basic">
                                <form>
                                    <div class="btn-group mb-1">
                                        <button type="button" class="btn btn-danger" @click="toggleClock"> {{ isRunning ? 'Clock Out' : 'Clock In' }}</button>
                                        <button type="button" class="btn btn-danger dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-expanded="false"></button>
                                        <div class="dropdown-menu" x-placement="bottom-start"
                                            style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(108px, 56px, 0px);">
                                            <div class="dropdown-item">
                                                <span class="time-start">
                                                    <i class="ti-upload"></i> {{ startTime }}
                                                </span>
                                                <span class="duration">{{ formattedTime }}</span>
                                                <span class="time-end">
                                                    {{ endTime }} <i class="ti-download"></i>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <li class="nav-item dropdown header-profile">
                            <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                ...
                                <div class="header-info" v-if="username">
                                    <span class="text-black"><strong>{{ username }}</strong></span>

                                    <p class="fs-12 mb-0" v-if="email">{{ email }}</p>
                                </div>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a href="./page-login.html" class="dropdown-item ai-icon">
                                    <span class="ml-2">Attendence QR Code </span>
                                </a>
                                <a href="./page-login.html" class="dropdown-item ai-icon">
                                    <span class="ml-2">Profile </span>
                                </a>
                                <a href="./page-login.html" class="dropdown-item ai-icon">
                                    <span class="ml-2">User Preference </span>
                                </a>
                                <a href="./page-login.html" class="dropdown-item ai-icon">
                                ...
                                <hr />
                                <a href="./page-login.html" class="dropdown-item ai-icon">
                                    <span class="ml-2">Failed Login Attempt </span>
                                </a>
                                <a href="./page-login.html" class="dropdown-item ai-icon">
                                    <span class="ml-2">Clear Cache </span>
                                </a>
                                <button href="#" class="dropdown-item ai-icon" @click="logout"><span class="ml-2">Logout</span></button>
                            </div>
                        </li>
                    </ul>
                </div>
    ...
    methods: {
        ...
        async logout() {
            try {
                ...
                const response = await saveData('/auth/logout');
